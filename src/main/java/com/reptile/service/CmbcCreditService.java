...
public class CmbcCreditService {
	 ...
	 * @throws Exception
	 */
	public synchronized Map<String, Object> doLogin(String number, String pwd,
...
//					HttpWatchUtil.sendStr(pwd);
	...
	public List<List<String>> getDetail() throws Exception {
		...
		String month = (String) JsonUtil.getJsonValue1(response, "Month");
		String year = (String) JsonUtil.getJsonValue1(response, "Year");

		String recentDate = year.substring(2) + month;
